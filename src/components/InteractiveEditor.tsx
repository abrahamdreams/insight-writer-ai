...
interface InteractiveEditorRef {
  getContent: () => string;
...
const InteractiveEditor = forwardRef<InteractiveEditorRef, InteractiveEditorProps>(({ onContentChange }, ref) => {
      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <Button
            ...
            className={`ml-auto ${showInlineSuggestions ? 'bg-accent/10 text-accent' : ''}`}
          >
            Smart Suggestions {showInlineSuggestions ? 'ON' : 'OFF'}
          </Button>
        </div>

        {/* Document Container */}
        <div className="bg-card rounded-lg shadow-[var(--document-shadow)] min-h-[800px] relative">
          {/* Toolbar */}
